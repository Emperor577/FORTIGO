...
(function ($) {
    ...
    $(document).on('ready', function () {
        ...
        $(".homepage-slides").on("translate.owl.carousel", function(){
            ...
            $(".homepage-slides p").removeClass("animated zoomIn").css("opacity", "0");
            $(".homepage-slides .btn").removeClass("animated fadeInDown").css("opacity", "0");
        });
        $(".homepage-slides").on("translated.owl.carousel", function(){
            $(".homepage-slides h1").addClass("animated fadeInUp").css("opacity", "1");
            $(".homepage-slides p").addClass("animated zoomIn").css("opacity", "1");
            $(".homepage-slides .btn").addClass("animated fadeInDown").css("opacity", "1");
        });
    });
